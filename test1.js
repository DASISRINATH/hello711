...
function Content(props) {
    ...
    const {isLoggedIn,loginuserId,csrfToken,setCsrfToken} = useContext(UserContext);
    ...
    const checkTab_3 = () => {
        if(posttype==='4') {
            if(categoryiddata==='catfa070dd5cc2a2c9c6196159f85480ff7') {
                ...
                if(subcategoryiddata!==''&&title!==''&&price!==''&&area!==''&&listedby!==''&&itemCondition!==''&&furnishing!==''&&floorNo!==''&&totalFloors!==''&&bedrooms!==''&&description!=='') {
                    setTab_3(false);
                    setErr(false);
                } else {
                    setTab_3(true);
            ...
            if(subcategoryiddata!==''&&title!==''&&price!==''&&area!==''&&listedby!==''&&itemCondition!==''&&furnishing!==''&&floorNo!==''&&totalFloors!==''&&bedrooms!==''&&carParking!==''&&description!=='') {
                setTab_3(false);
                setErr(false);
            } else {
                setTab_3(true);
    ...
    const checkTab_5 = () => {
        if(!tab_3 && city!=='' && latitude!=='' && address!=='') {setTab_4(false);setErr(false);}
        else {setTab_4(true);console.log("turu")}
    }
    ...
    useEffect(() => {
        checkTab_3();
    },[price,area,listedby,itemCondition,furnishing,floorNo,description,totalFloors,bedrooms,carParking,title,categoryiddata,subcategoryiddata])
    ...
    const ResetForm = ()=>{
        ...
        <Locationtab  center={center} getAddressdata={getAddressdata} getlatlngdata={getlatlngdata}/>
    }
                ...
                <div className="row">
                    <Tab.Container activeKey={activeKey} onSelect={(key) => setActiveKey(key)}>
                                ...
                                <div className="candidate-info">
                                    <ul>
                                        <Nav>
                                            ...
                                            <li className="candidate-submit-option" onClick={() => {
                                                if(tab_3) setErr(true);
                                            }} style={{width:"100%",marginTop:'0px'}}><Nav.Item>
                        ...
                        <div className="col-md-9">
                            <form style={{borderRadius: "5px",overflow: "hidden"}} className="shadow-submit"  id="submit-listing" onSubmit={csrfSubmitCheck}>
                                <Tab.Content className="m-0">
                                    ...
                                    <div className="job-bx job-profile">
                                        ...
                                        <div className="row">
                                            ...
                                            {pname==="1" && (
                                                ...
                                                <label>Category<i class="mandatory fa fa-asterisk" aria-hidden="true"></i></label>
                                                ...
                                                onChange={e =>{setSubcategoryiddata(e.target.value);}} >
                                                    ...
                                                    <option value="subcata6ca03906a86602a88fc7d9048105c67">Commercial Plot</option>
                                            ...
                                            <div className={`col-md-${pname==='1' ? "6" : "12"} form-group`}>
                                            ...
                                            <div className="col-md-4 form-group">
                                                ...
                                                <input type="number" className="form-control" placeholder="Enter Price" value={price} onChange={e => numericVal(e.target.value,setPrice,10)}  />
                                            </div>
                                            {posttype === "2" && (
                                                <div className="col-md-4 form-group">
                                                    <label>Rent collection type<i class="mandatory fa fa-asterisk" aria-hidden="true"></i></label>
                                                    <div className="form-control">
                                            ...
                                            {categoryiddata === 'cat445639833db3eff8b6cdb5510aa39faa' && <>
                                            <div className="col-md-4 form-group">
                                                <label>Furnishing<i class="mandatory fa fa-asterisk" aria-hidden="true"></i></label>
                                                <div className="form-control">
                                                <select className="Content_arrow_spacing" name="type"  onChange={e =>setFurnishing(e.target.value)}>
                                                    <option value="">Select Furnishing</option>
                                                    <option value="fur_26d602a6b84f799c487eafb604d4260a">Furnished</option>
                                                    <option value="fur_6b24b00443f4a2a8c96ffc282faaa457">Semi-furnished</option>
                                                    <option value="fur_9fb1ee9824da0192ff19b4d99a4a83b8">Unfurnished</option>
                                                </select>
                                                </div>
                                            </div>
                                            <div className="col-md-4 form-group">
                                                <label>Condition of item<i class="mandatory fa fa-asterisk" aria-hidden="true"></i></label>
                                                <div className="form-control">
                                            ...
                                            <div className="col-md-4 form-group">
                                                <label>Floor No<i class="mandatory fa fa-asterisk" aria-hidden="true"></i></label>
                                                <input type="number" className="form-control" placeholder="Enter Floor No" value={floorNo} onChange={e => numericVal(e.target.value,setFloorNo,3)}  />
                                            </div>
                                            <div className="col-md-4 form-group">
                                                <label>House Type<i class="mandatory fa fa-asterisk" aria-hidden="true"></i></label>
                                                <div className="form-control">
                                            ...
                                            <div className="col-md-4 form-group">
                                                <label>Total Floors<i class="mandatory fa fa-asterisk" aria-hidden="true"></i></label>
                                                <input type="number" className="form-control" placeholder="Enter Total Floors" value={totalFloors} onChange={e => numericVal(e.target.value,setTotalFloors,3)}  />
                                            </div>
                                            <div className="col-md-4 form-group">
                                                <label>Car Parking<i class="mandatory fa fa-asterisk" aria-hidden="true"></i></label>
                                                <input type="number" className="form-control" placeholder="Enter Car Parking" value={carParking} onChange={e => numericVal(e.target.value,setCarParking,2)}  />
                                            </div></>}
                                            <div className="col-md-4 form-group">
                                                <label>Area<i class="mandatory fa fa-asterisk" aria-hidden="true"></i></label>
                                                <div className="input-group">
                                                    <input type="text" className="form-control" name="Plot_Area" placeholder="Plot Area" value={area} onChange={e => numericVal(e.target.value,setArea,6)}  />
                                            ...
                                            <div className="col-md-4 form-group">
                                                ...
                                                <div className="form-control">
                                                <select className="Content_arrow_spacing" name="type"  onChange={e =>setListedby(e.target.value)}>
                                            ...
                                            {categoryiddata === 'catfa070dd5cc2a2c9c6196159f85480ff7' && <>
                                            <div className="col-md-4 form-group">
                                                <label>Plot Type<i class="mandatory fa fa-asterisk" aria-hidden="true"></i></label>
                                                <div className="form-control">
                                            ...
                                            <div className="col-md-4 form-group">
                                                <label>Rera Id<i class="mandatory fa fa-asterisk" aria-hidden="true"></i></label>
                                                <input type="text" className="form-control" placeholder="Enter Rera Id" value={reraId} onChange={e =>setReraId(e.target.value)}  />
                                            </div>

                                            <div className="col-md-6 form-group">
                                                <label>LP Number<i class="mandatory fa fa-asterisk" aria-hidden="true"></i></label>
                                            ...
                                            <div className="col-md-6 form-group">
                                                ...
                                                <input type="url" className="form-control" placeholder="Enter Youtube Link" value={YoutubeLink} onChange={e=>setYoutubeLink(e.target.value)} />
                                            </div></>}
                                            ...
                                            <div class="col-md-12">
                                                <Form.Group controlId="formBasicCheckbox">
                                                  <Form.Check type="checkbox" label="Show WhatsApp Number" onChange={e=>(e.target.checked ? setWhatsappAllowed("1") : setWhatsappAllowed("0"))} />
                                                </Form.Group>
                                            </div>
                                            <div className="col-md-12 form-group">
                                    ...
                                    <Tab.Pane eventKey="tab3">
                                        <div className="job-bx job-profile">
                                            ...
                                            <div className="row">
                                                ...
                                                <Locationtab  center={center} getAddressdata={getAddressdata} getlatlngdata={getlatlngdata} changecenter={s}/>
                                                <div className="col-md-12 form-group">
                                                ...
                                                {err ? <div className="col-sm-12 form-group"><h5 className="text-danger">Fill all the mandatory fields</h5></div> : null}
                                    ...
                                    <Tab.Pane eventKey="tab4">
                                        <div className="job-bx job-profile">
                                            ...
                                            <div className="row">
                                                {categoryiddata === 'catfa070dd5cc2a2c9c6196159f85480ff7' && 
                                                <>
                                                <div style={{marginBottom: "0px"}} className="col-md-12 form-group">
                                                ...
                                                <div style={{padding: "0px 25px"}} className="row col-sm-12">
                                                <div className="col-lg-2_5 col-md-4 col-sm-6">
                                                    <label className="acr-listing-feature">
                                                        <input type="checkbox" value={gatedCommunity} onClick={e=>(e.target.checked?setGatedCommunity("1"):setGatedCommunity("0")) } />
                                                        <i className="acr-feature-check fas fa-check" />
                                                        <img className="acr-listing-feature-icon flaticon-company" src={gatedIcon} alt="swimming pool" />
                                                        Gated Community
                                                    </label>
                                                </div>
                                                <div className="col-lg-2_5 col-md-4 col-sm-6">
                                                    <label className="acr-listing-feature">
                                                        <input type="checkbox" value={waterSupply} onClick={e=>(e.target.checked?setWaterSupply("1"):setWaterSupply("0")) } />
                                                        <i className="acr-feature-check fas fa-check" />
                                                        <img className="acr-listing-feature-icon flaticon-company" src={waterIcon} alt="swimming pool" />
                                                        24 water Supply
                                                    </label>
                                                </div>
                                                <div className="col-lg-2_5 col-md-4 col-sm-6">
                                                    <label className="acr-listing-feature">
                                                        <input type="checkbox" value={swimmingPool} onClick={e=>(e.target.checked?setSwimmingPool("1"):setSwimmingPool("0")) } />
                                                        <i className="acr-feature-check fas fa-check" />
                                                        <img className="acr-listing-feature-icon flaticon-company" src={swimIcon} alt="swimming pool" />
                                                        Swimming Pool
                                                    </label>
                                                </div>
                                                <div className="col-lg-2_5 col-md-4 col-sm-6">
                                                    <label className="acr-listing-feature">
                                                        <input type="checkbox" value={gym} onClick={e=>(e.target.checked?setGym("1"):setGym("0")) } />
                                                        <i className="acr-feature-check fas fa-check" />
                                                        <img className="acr-listing-feature-icon flaticon-company" src={gymIcon} alt="swimming pool" />
                                                        Gym
                                                    </label>
                                                </div>
                                                <div className="col-lg-2_5 col-md-4 col-sm-6">
                                                    <label className="acr-listing-feature">
                                                        <input type="checkbox" value={park} onClick={e=>(e.target.checked?setPark("1"):setPark("0")) } />
                                                        <i className="acr-feature-check fas fa-check" />
                                                        <img className="acr-listing-feature-icon flaticon-company" src={parkIcon} alt="swimming pool" />
                                                        Park
                                                    </label>
                                                </div>
                                                <div className="col-lg-2_5 col-md-4 col-sm-6">
                                                    <label className="acr-listing-feature">
                                                        <input type="checkbox" value={joggingTrack} onClick={e=>(e.target.checked? setJoggingTrack("1"): setJoggingTrack("0")) } />
                                                        <i className="acr-feature-check fas fa-check" />
                                                        <img className="acr-listing-feature-icon flaticon-company" src={jogIcon} alt="swimming pool" />
                                                        Jogging Track
                                                    </label>
                                                </div>
                                                <div className="col-lg-2_5 col-md-4 col-sm-6">
                                                    <label className="acr-listing-feature">
                                                        <input type="checkbox" value={tennisCourt} onClick={e=>(e.target.checked? setTennisCourt("1"): setTennisCourt("0")) } />
                                                        <i className="acr-feature-check fas fa-check" />
                                                        <img className="acr-listing-feature-icon flaticon-company" src={tennisIcon} alt="swimming pool" />
                                                        Tennis Court
                                                    </label>
                                                </div>
                                                <div className="col-lg-2_5 col-md-4 col-sm-6">
                                                    <label className="acr-listing-feature">
                                                        <input type="checkbox" value={library} onClick={e=>(e.target.checked? setLibrary("1"): setLibrary("0")) } />
                                                        <i className="acr-feature-check fas fa-check" />
                                                        <img className="acr-listing-feature-icon flaticon-company" src={libraryIcon} alt="swimming pool" />
                                                        Library
                                                    </label>
                                                </div>
                                                <div className="col-lg-2_5 col-md-4 col-sm-6">
                                                    <label className="acr-listing-feature">
                                                        <input type="checkbox" value={spa} onClick={e=>(e.target.checked? setSpa("1"): setSpa("0")) } />
                                                        <i className="acr-feature-check fas fa-check" />
                                                        <img className="acr-listing-feature-icon flaticon-company" src={spaIcon} alt="swimming pool" />
                                                        Spa
                                                    </label>
                                                </div>
                                                <div className="col-lg-2_5 col-md-4 col-sm-6">
                                                    <label className="acr-listing-feature">
                                                        <input type="checkbox" value={indoorGame} onClick={e=>(e.target.checked? setIndoorGame("1"): setIndoorGame("0")) } />
                                                        <i className="acr-feature-check fas fa-check" />
                                                        <img className="acr-listing-feature-icon flaticon-company" src={indoorIcon} alt="swimming pool" />
                                                        Indoor Games
                                                    </label>
                                                </div>
                                                <div className="col-lg-2_5 col-md-4 col-sm-6">
                                                    <label className="acr-listing-feature">
                                                        <input type="checkbox" value={tour} onClick={e=>(e.target.checked? setTour("1"): setTour("0")) } />
                                                        <i className="acr-feature-check fas fa-check" />
                                                        <img className="acr-listing-feature-icon flaticon-company" src={tourIcon} alt="swimming pool" />
                                                        3D Tour
                                                    </label>
                                                </div>
                                                </div>
                                    ...
                                    <Tab.Pane eventKey="tab2">
                                        ...
                                        */}
                                        <div className="job-bx job-profile">
											<div className="job-bx-title clearfix">
												<h5 className="font-weight-700 pull-left text-uppercase">Gallery</h5>
												<Link to={"./"} className="site-button right-arrow button-sm float-right">Back</Link>
											</div>
                                            <div className="row">
                                                <div className="col-md-12 form-group">
                                                ...
                                                <div className="col-md-12 form-group">
                                                    <button type="submit"  className="btn-custom" name="submit" onClick={()=>setAllowed(true)}>Submit Listing</button>
                                            ...
                                            {uploadingmsg ? (<h5 className="text-center text-info">Uploading...</h5>) : <SubmitModal refresh={refreshPage} uploadmsgstatus={uploadmsgstatus} allowed={allowed} close={closeSubmitModal}/>}
                                            {err && <div className="col-sm-12 form-group"><h5 className="text-danger">Fill all the mandatory fields</h5></div> }
