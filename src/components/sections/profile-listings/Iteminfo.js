    ...
    <>
        <div className="listing-content">
            ...
            <div className="listing-price">
                <h4 className="custom-primary ">Rs.{item.price}</h4>
            </div>
            <span className="listing-address"> <i className="fas fa-map-marker-alt" /> {item.address}</span>
            <p>{item.description}</p>
        </div>
        <div style={{paddingBottom: "0"}} className="section section-padding pt-0 acr-listing-features">
                ...
                <div className="col-lg-6 col-md-6">
                    <div className="listing-feature-wrapper">
                        <div className="listing-feature">
                            ...
                            <span className="listing-feature-value">{item.category.cat_name}</span>
                        </div>
                        <div className="listing-feature">
