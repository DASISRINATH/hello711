                            ...
                            <div className="col-lg-12">
                                <div className="listing-banner-inner">
                                    ...
                                    <Slider className="listing-banner-slider" ref={c => (this.slider = c)} {...settings}>
                                        {sliderpost.filter(images => images.img_type === 'item' ).map((item, i) => (
                                    ...
                                    <div className="listing-item-path">
                                        <Link to="/">Home</Link> <ArrowForwardIosIcon fontSize="small" style={{margin: "0 5px"}}/> <Link to="/projects">Projects</Link> <ArrowForwardIosIcon fontSize="small" style={{margin: "0 5px"}} /> {
                                        itemData.title.length > 30 ? (itemData.title.slice(0,27)+"...") : (itemData.title) }
                                    </div>
                                    ...
                                    <div className="listing-item-cont">
                                        ...
                                        <div style={{paddingRight: "10px"}} className="listing-item-lists"><RoomIcon />{" Map   "}</div>
                                    </div>
                ...
                <div className="section listing-wrapper" style={{paddingTop:'40px'}}>
                    <div className="container">
                        <div style={{position: "relative"}} className="mb-30 Itemd__title">
                            <span>Overview</span>
                            <Link to={{pathname: `https://api.whatsapp.com/send?phone=&text=Hey!%20I%20found%20a%20Listing%20:%20https://risee.in/projects/${itemData.id}%20in%20INDMarketplace%20website`}} target="_blank">
                            ...
                            <div className="col-lg-8">
                                ...
                                <div className="mb-30 row">
                                    ...
                                    <div className="mb-10 col-md-4">
                                        <div className="Itemd__option">Property Status</div>
                                        <div className="Item__opdetails">
                                            <i class="icon-2x far fa-calendar-alt"></i>
                                            <span>{itemData.condition_of_item.name}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="Itemd__col-lg-6"> 
                                    ...
                                    <div>
                                        {
                                            itemData.project_details.about_project.length > 300 ? (
                                                <Fragment>
                                                    <div className="fs-15r mb-20 mt-30 Itemd__title">About {itemData.project_name}</div>
                                                    {
                                                    ...
                                                    itemData.project_details.about_project !== '' && (
                                                        <Fragment>
                                                            <div className="mb-30 mt-30 Itemd__title">About {itemData.project_name}</div>
                                                            {itemData.project_details.about_project}
                                                        </Fragment>
                                                    )
                                    ...
                                    <div className="mb-20 mt-30 Itemd__title">Amenties</div>
                                    <div className="row">
                                        {
                                    ...
                                    <div className="fs-15r mb-10 mt-20 Itemd__title">Location</div>
                                    <div className="mb-10">{itemData.address}</div>
                                    <Listingmap lat={itemData.lat} lng={itemData.lng}/>
                        ...
                        {console.log('Test loading  End...')}
                                ...
                                <div>
                                        {
                                            itemData.about_builder.length > 300 ? (
                                                <Fragment>
                                                    <div className="mb-20 mt-30 Itemd__title">About Builder</div>
                                                    {
                                                        this.state.viewAbout ? (
                                                            <div>
                                            ...
                                            itemData.about_builder !== "" && (
                                                <Fragment>
                                                    <div className="mb-30 mt-30 Itemd__title">About Builder</div>
                                                    {itemData.about_builder}
                                                </Fragment>
                                            )
                                        }
                                    ...
                                    <div className="fs-15r mb-20 mt-30 Itemd__title">Similar Projects</div>
                                    <div>
                                        {this.state.similarProperties.length >=3 ? (<Fragment>
                                            ...
                                            <div className="row">
                                                {this.state.similarProperties.map((item,i) => (
                                                        <div className="col-md-4">
                                                            <div className="similarProp">
                                                                <Link to={"/projects/"+item.id} target="_blank">
                                                                    <img 
                            ...
                            <div className="col-lg-4">
                                <div className="mg-none sidebar sticky-sidebar">
                                    <div className="sidebar-widget">
                                        {/* Author Start */}
                                        {itemData && (
                                            <div className="propDetails">
                                                ...
                                                <div className="mb-20">
                                                    <span>Project By : {itemData.organisation.org_name}</span>
                                                </div>
                                            </div>
                                        )
                                        }
                                        ...
                                        {
                                            itemData && (
                                                <div className="propCompany">
                                                    <div className="companyName">{itemData.organisation.org_name}</div>
                                                    <div className="companyDetails">
                                                        <div className="companyImg">
                                                            <img src={itemData.project_details.project_icon} alt="Company_Image" />
                                                        </div>
                                                        <div className="companyInfo">
                                                            <div>
                                                                {itemData.is_verified && (
                                                                    <Fragment>
                                                                        <VerifiedUserIcon style={{marginRight: "10px",color: "green"}} /> {" Verified"}
                                                                    </Fragment>
                                                                )}
                                                            </div>
                                                            <div>
                                                                <PersonIcon style={{marginRight: "10px"}} /> {itemData.listed_by_name}
                                                            </div>
                                                            <button className="companyLink">Visit Link</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            )
