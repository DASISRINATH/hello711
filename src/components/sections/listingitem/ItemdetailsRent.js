                            ...
                            <div className="col-lg-12">
                                <div className="listing-banner-inner">
                                    ...
                                    <div className="listing-item-path">
                                        <Link to="/">Home</Link>  <ArrowForwardIosIcon fontSize="small" style={{margin: "0 5px"}}/> <Link to="/rent">Rent</Link> <ArrowForwardIosIcon fontSize="small" style={{margin: "0 5px"}} /> {
                                        itemData.title.length > 30 ? (itemData.title.slice(0,27)+"...") : (itemData.title) }
                                    </div>
                ...
                <div className="section listing-wrapper" style={{paddingTop:'40px'}}>
                    <div className="container">
                        <div style={{position: "relative"}} className="mb-30 Itemd__title">
                            ...
                            <Link to={{pathname: `https://api.whatsapp.com/send?phone=&text=Hey!%20I%20found%20a%20Listing%20:%20https://risee.in/rent/${itemData.id}%20in%20INDMarketplace%20website`}} target="_blank">
                                              <div style={{height: "25px",padding: "0 5px",fontSize: "0.8rem"}} className="listing-whtapp-btn">
                                                  <WhatsAppIcon style={{width: "1rem",height: "1rem"}} /> 
                                                  <span>Share</span>
                                              </div>
                                            </Link>
                            {/* <div>
                                    ...
                                    <div>
                                        {
                                            itemData.about_builder.length > 300 ? (
                                                <Fragment>
                                                    <div className="fs-15r mb-20 mt-30 Itemd__title">About</div>
                                                    {
                                            ...
                                            itemData.about_builder !== "" && (
                                                <Fragment>
                                                    <div className="mb-20 mt-30 Itemd__title">About</div>
                                                    {itemData.about_builder}
                                                </Fragment>
                                            )
                                        }
                                            ...
                                            this.state.amenties.length > 6 ? (
                                                ...
                                                this.state.amenties.map((item,i) => (
                                                    <div className="mb-10 col-md-4 col-sm-6">
                                                        <div className="Item__opdetails">
                                                            <img className="itemD-icon" src={this.state.amentiesIcon[i]} alt="" />
                                                            <span>{item.slice(3,item.length).split("_").map(val => val+" ")}</span>
                                                        </div>
                                                    </div>
                                                ))
                                            )
                                ...
                                <div>
                                        {
                                            itemData.project_details.about_project.length > 300 ? (
                                                <Fragment>
                                                    <div className="fs-15r mb-30 mt-30 Itemd__title">About Project</div>
                                                    {
                                                        this.state.viewAbout ? (
                                                            <div>
                                                                {itemData.project_details.about_project}
                                    ...
                                    <div className="sidebar-widget">
                                        ...
                                        {itemData && (
                                            <div className="propDetails">
                                                ...
                                                <div className="mb-10">
                                                    <span className="fs-14r" style={{fontSize: "1.7rem",color: "black",fontWeight: "600"}}>Rs. {itemData.item_price}</span>
                                                    <span style={{color:"#101737",marginLeft: "10px"}}>/Month</span>
