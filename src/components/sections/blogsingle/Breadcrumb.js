...
<div className="subheader subheader-2 bg-cover bg-center dark-overlay">
                    <div className="container">
                    <div className="subheader-inner">
                        <h1 className="text-white">{this.props.data.name}</h1>
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                                <li className="breadcrumb-item"><Link to="/"> <i className="fas fa-home" /> </Link></li>
                                <li className="breadcrumb-item"><Link to="/blog-list">Blog</Link></li>
