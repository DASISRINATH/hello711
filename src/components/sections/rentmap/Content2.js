...
const Content = (props) => {
  ...
  const {offset, setOffset, items, setItems, locationName, setLocationName, selectedLocation,setSelectedLocation,center,setCenter,zoomLevel,setZommLevel,checkCenterZoom, s, setS} = useContext(LocationContext);
                       ...
                       <div className="listing-body">
                        ...
                        <div onClick={() => {
                         ...
                         <span className="listing-price">
                           {'Rs.'+item.price}
                           <span style={{fontWeight: "600", color:"#101737"}}> / Month</span>
                         </span>
