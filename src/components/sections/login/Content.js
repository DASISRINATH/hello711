                ...
                <div className="acr-auth-content">
                    <form method="post">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control form-control-light" placeholder="Mobile Number" name="username" />
                        </div>
                        {/* <div className="form-group">
                       ...
                       <Link to="/otp-token"><button type="submit" className="btn-custom secondary btn-block">Login</button></Link>
