...
const Form = () => {
  ...
  return(
    <form onSubmit={submitHandler}>
      <h1 className="is-size-3 has-text-centered mb-4">Your Number has been verified Successfully</h1>
      <h4 className="has-text-centered mb-4">Please Enter your Details, so that we can serve you better</h4>
