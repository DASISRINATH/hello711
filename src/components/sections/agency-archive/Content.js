            ...
            return <div key={i} className="col-lg-6">
                <div className="acr-agent">
                    ...
                    <div className="acr-dots-wrapper acr-agent-thumb">
                        ...
                        <Link to="/agency-details"><img src={process.env.PUBLIC_URL + "/" + item.img} alt="agent" /></Link>
                    </div>
                    <div className="acr-agent-body">
                        <h6> <Link to="/agency-details">{item.name}</Link> </h6>
                        <span>{item.post}</span>
                        <p>{item.text}</p>
                        <Link to="/agency-details" className="btn-custom secondary btn-sm">View Profile</Link>
                    </div>
                </div>
            </div>
        });
