                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-5 col-sm-12 footer-widget">
                            <div className="footer-logo"> <img src={process.env.PUBLIC_URL + "/assets/img/hello71-wt-logo.svg"} alt="hello71" /> </div>
                        ...
                        <div className="col-lg-2 offset-lg-1 col-sm-4 col-xs-6 footer-widget">
                            ...
                            <ul>
                                <li> <Link to="/">{t('footer:middle.trainers')}</Link> </li>
                                <li> <Link to="/">{t('footer:middle.become_trainer')}</Link> </li>
                                <li> <Link to="/">{t('footer:middle.join_student')}</Link> </li>
