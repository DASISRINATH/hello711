                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{ margin: 'auto', background: '#fff', display: 'block', shapeRendering: 'auto' }} width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                    <g transform="translate(80,50)">
                        <g transform="rotate(0)">
                            <circle cx={0} cy={0} r={6} fill="#6A307D" fillOpacity={1}>
                        ...
                        <g transform="rotate(45)">
                            <circle cx={0} cy={0} r={6} fill="#6A307D" fillOpacity="0.875">
                        ...
                        <g transform="rotate(90)">
                            <circle cx={0} cy={0} r={6} fill="#6A307D" fillOpacity="0.75">
                        ...
                        <g transform="rotate(135)">
                            <circle cx={0} cy={0} r={6} fill="#6A307D" fillOpacity="0.625">
                        ...
                        <g transform="rotate(180)">
                            <circle cx={0} cy={0} r={6} fill="#6A307D" fillOpacity="0.5">
                        ...
                        <g transform="rotate(225)">
                            <circle cx={0} cy={0} r={6} fill="#6A307D" fillOpacity="0.375">
                        ...
                        <g transform="rotate(270)">
                            <circle cx={0} cy={0} r={6} fill="#6A307D" fillOpacity="0.25">
                        ...
                        <g transform="rotate(315)">
                            <circle cx={0} cy={0} r={6} fill="#6A307D" fillOpacity="0.125">
